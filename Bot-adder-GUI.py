...
def login_pg1():
    ...
    widget_list = [login_pg1_lbl1,
                   login_pg1_phone_num_ent, login_pg1_Enter_btn]
...
def login_pg2():
    ...
    try:
        ...
        widget_list = [login_pg2_lbl1, login_pg2_code_num_ent,
                       login_pg2_Enter_btn, login_pg2_back_btn]
...
def login_pg3():
    ...
    widget_list = [login_pg3_pass_ent,
                   login_pg3_pass_show, login_pg3_Enter_btn]
...
def config_pg1():
    ...
    config_pg1_reopen_file_btn = Button(
        text='Reopen', command=get_path_to_file)
    ...
    widget_list = [config_pg1_file_path_lbl1, config_pg1_reopen_file_btn,
                   config_pg1_listbox, config_pg1_confirm_btn]
...
def config_pg2():
    ...
    if filename.get() == '' and chat_name == "nothing is selected":
        ...
        try:
            ...
            config_pg2_user_count_lbl = Label(
            ...
            config_pg2_user_count_ent.bind(
                "<Key>", config_pg2_user_count_ent_bind)
            config_pg2_user_count_ent.place(x=270, y=160, width=60, height=20)

            config_pg2_confirm_btn = Button(
                text='Confirm', command=add_members)
            ...
            widget_list = [config_pg2_user_count_lbl, config_pg2_user_count_ent,
                           config_pg2_confirm_btn, config_pg2_back_btn]
        except Exception as e:
